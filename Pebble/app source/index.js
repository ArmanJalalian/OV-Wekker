/**
 * Created by Arman Jalalian on 6/27/2017.
 */
// Rocky.js
...
function drawWeather(ctx, weather) {
    ...
    var arrivedString = arrived;

    console.log(arrivedString);

    // Draw the text, top center
    ctx.fillStyle = 'lightgray';
    ctx.textAlign = 'center';
    ctx.font = '14px Gothic';
    ctx.fillText(arrivedString, ctx.canvas.unobstructedWidth / 2, 2);
}
